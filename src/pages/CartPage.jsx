...
let groupedCart = cart.length? cart.reduce((acc, current) => {
...
const calculateOverallTotal = () => {
  return groupedCart.reduce((total, item) => total + calculateItemTotal(item), 0);
};
                ...
                <div className="row" key={item.product._id}>
                  <div className="col-lg-3 col-md-12 mb-4 mb-lg-0">
                    <div className="bg-image hover-overlay hover-zoom ripple rounded" data-mdb-ripple-color="light">
                      <img src={item.product.img} className="w-100" alt="Blue Jeans Jacket" />
                      <a href="#!">
